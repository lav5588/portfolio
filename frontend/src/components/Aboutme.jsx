...
const Aboutme = () => {
  return (
    <div className='text-White flex flex-col xl:flex-row justify-between  items-center gap-10 lg:gap-20'>
      <div className='flex flex-col justify-between  items-start md:items-start gap-5'>
        <h1 className='border border-[0.3rem] border-Brand1 inline-block  rounded-tl-[2.5rem] rounded-br-[2.5rem] bg-BG1 py-3 px-5  text-5xl flex justify-center items-center'>About Me</h1>
        <div className='bg-BG1 rounded-[2.5rem] p-4 text-xl xl:text-sm flex flex-col gap-5'>
          <h1 className='text-4xl xl:text-3xl text-Brand1'>Hello!</h1>
